...
@Component({
  selector: 'app-code-productionactivityandqualityreport',
  templateUrl: './code-productionactivityandqualityreport.page.html',
  styleUrls: ['./code-productionactivityandqualityreport.page.scss'],
})
export class CodeProductionactivityandqualityreportPage implements OnInit {
