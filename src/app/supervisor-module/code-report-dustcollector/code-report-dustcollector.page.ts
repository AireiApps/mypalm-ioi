...
@Component({
  selector: 'app-code-report-dustcollector',
  templateUrl: './code-report-dustcollector.page.html',
  styleUrls: ['./code-report-dustcollector.page.scss'],
})
export class CodeReportDustcollectorPage implements OnInit {
