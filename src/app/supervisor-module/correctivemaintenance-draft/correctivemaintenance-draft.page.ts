...
@Component({
  selector: "app-correctivemaintenance-draft",
  templateUrl: "./correctivemaintenance-draft.page.html",
  styleUrls: ["./correctivemaintenance-draft.page.scss"],
})
export class CorrectivemaintenanceDraftPage implements OnInit {
