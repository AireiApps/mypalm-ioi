...
@Component({
  selector: "app-correctivemaintenance-new",
  templateUrl: "./correctivemaintenance-new.page.html",
  styleUrls: ["./correctivemaintenance-new.page.scss"],
})
export class CorrectivemaintenanceNewPage implements OnInit {
