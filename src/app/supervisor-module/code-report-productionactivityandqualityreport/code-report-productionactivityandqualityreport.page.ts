...
@Component({
  selector: 'app-code-report-productionactivityandqualityreport',
  templateUrl: './code-report-productionactivityandqualityreport.page.html',
  styleUrls: ['./code-report-productionactivityandqualityreport.page.scss'],
})
export class CodeReportProductionactivityandqualityreportPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/Production_activity_report?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
