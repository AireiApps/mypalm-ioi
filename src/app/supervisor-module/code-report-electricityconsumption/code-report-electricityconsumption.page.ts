...
@Component({
  selector: 'app-code-report-electricityconsumption',
  templateUrl: './code-report-electricityconsumption.page.html',
  styleUrls: ['./code-report-electricityconsumption.page.scss'],
})
export class CodeReportElectricityconsumptionPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/Electricity_consumption_report?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
