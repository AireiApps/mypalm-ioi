...
@Component({
  selector: 'app-code-report-runninghours',
  templateUrl: './code-report-runninghours.page.html',
  styleUrls: ['./code-report-runninghours.page.scss'],
})
export class CodeReportRunninghoursPage implements OnInit {
