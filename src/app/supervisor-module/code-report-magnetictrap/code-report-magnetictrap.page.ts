...
@Component({
  selector: 'app-code-report-magnetictrap',
  templateUrl: './code-report-magnetictrap.page.html',
  styleUrls: ['./code-report-magnetictrap.page.scss'],
})
export class CodeReportMagnetictrapPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/Magnetic_trap_report?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
