...
@Component({
  selector: 'app-code-report-waterconsumption',
  templateUrl: './code-report-waterconsumption.page.html',
  styleUrls: ['./code-report-waterconsumption.page.scss'],
})
export class CodeReportWaterconsumptionPage implements OnInit {
