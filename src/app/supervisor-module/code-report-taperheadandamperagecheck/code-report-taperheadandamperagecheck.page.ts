...
@Component({
  selector: 'app-code-report-taperheadandamperagecheck',
  templateUrl: './code-report-taperheadandamperagecheck.page.html',
  styleUrls: ['./code-report-taperheadandamperagecheck.page.scss'],
})
export class CodeReportTaperheadandamperagecheckPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/Checklist_hourly_report_mobile?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
