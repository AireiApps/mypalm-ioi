...
@Component({
  selector: "app-correctivemaintenance-new-save",
  templateUrl: "./correctivemaintenance-new-save.page.html",
  styleUrls: ["./correctivemaintenance-new-save.page.scss"],
})
export class CorrectivemaintenanceNewSavePage implements OnInit {
  ...
  addNewRow() {
    ...
    if (this.newcorrectivemaintenanceForm.valid) {
      if (this.totalrunninghour != "") {
        ...
        this.commonservice.presentToast(
          "error",
          "Total Running Hours is mandatory. Please ensure that the current running hours are greater than the previous running hours."
        );
      }
    } else {
