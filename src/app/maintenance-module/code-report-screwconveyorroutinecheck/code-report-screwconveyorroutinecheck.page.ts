...
@Component({
  selector: 'app-code-report-screwconveyorroutinecheck',
  templateUrl: './code-report-screwconveyorroutinecheck.page.html',
  styleUrls: ['./code-report-screwconveyorroutinecheck.page.scss'],
})
export class CodeReportScrewconveyorroutinecheckPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/press_machine_routine_check/6?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
