...
@Component({
  selector: 'app-correctivemaintenance-view',
  templateUrl: './correctivemaintenance-view.page.html',
  styleUrls: ['./correctivemaintenance-view.page.scss'],
})
export class CorrectivemaintenanceViewPage implements OnInit {
