...
@Component({
  selector: 'app-code-ftl-plantsystemmaintenancereport',
  templateUrl: './code-ftl-plantsystemmaintenancereport.page.html',
  styleUrls: ['./code-ftl-plantsystemmaintenancereport.page.scss'],
})
export class CodeFtlPlantsystemmaintenancereportPage implements OnInit {
  ...
  constructor(public modalController: ModalController, public navParams: NavParams, private fb: FormBuilder, private commonservice: AIREIService, private service: MaintenanceServiceService) {
  ...
  onChangeMaintenanceType() {
    if (this.plantsystemmaintenancereportForm.value.select_maintenancetype != "") {

      this.getWorkOrderNo(JSON.parse(this.plantsystemmaintenancereportForm.value.select_maintenancetype).id);
  ...
  save()
  {
    var getqr_date = moment(this.plantsystemmaintenancereportForm.value.txt_date).format("YYYY-MM-DD");

    var getec_date = moment(this.plantsystemmaintenancereportForm.value.txt_date).format("YYYY-MM-DD HH:mm:ss");
    ...
    if (this.plantsystemmaintenancereportForm.valid) {
      var req = {
        ...
        maintenancetype: String(JSON.parse(this.plantsystemmaintenancereportForm.value.select_maintenancetype).id), 
        ...
        observation: this.plantsystemmaintenancereportForm.value.select_observation,
        teamlead: "0",
        staffid: "0",
