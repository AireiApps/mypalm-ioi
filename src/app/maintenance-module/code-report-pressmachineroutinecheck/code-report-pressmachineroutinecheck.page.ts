...
@Component({
  selector: 'app-code-report-pressmachineroutinecheck',
  templateUrl: './code-report-pressmachineroutinecheck.page.html',
  styleUrls: ['./code-report-pressmachineroutinecheck.page.scss'],
})
export class CodeReportPressmachineroutinecheckPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/press_machine_routine_check/3?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
