...
@Component({
  selector: 'app-code-report-pressmachinelubricationreport',
  templateUrl: './code-report-pressmachinelubricationreport.page.html',
  styleUrls: ['./code-report-pressmachinelubricationreport.page.scss'],
})
export class CodeReportPressmachinelubricationreportPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/press_machine_routine_check/5?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
