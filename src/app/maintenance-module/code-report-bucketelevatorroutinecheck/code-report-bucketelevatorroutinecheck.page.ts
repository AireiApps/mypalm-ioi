...
@Component({
  selector: 'app-code-report-bucketelevatorroutinecheck',
  templateUrl: './code-report-bucketelevatorroutinecheck.page.html',
  styleUrls: ['./code-report-bucketelevatorroutinecheck.page.scss'],
})
export class CodeReportBucketelevatorroutinecheckPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/press_machine_routine_check/7?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
