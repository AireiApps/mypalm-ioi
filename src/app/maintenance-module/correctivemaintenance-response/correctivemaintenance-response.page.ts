...
@Component({
  selector: 'app-correctivemaintenance-response',
  templateUrl: './correctivemaintenance-response.page.html',
  styleUrls: ['./correctivemaintenance-response.page.scss'],
})
export class CorrectivemaintenanceResponsePage implements OnInit {
