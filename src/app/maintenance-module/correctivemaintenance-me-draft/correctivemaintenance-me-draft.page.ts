...
@Component({
  selector: "app-correctivemaintenance-me-draft",
  templateUrl: "./correctivemaintenance-me-draft.page.html",
  styleUrls: ["./correctivemaintenance-me-draft.page.scss"],
})
export class CorrectivemaintenanceMeDraftPage implements OnInit {
    ...
    if (this.newcorrectivemaintenanceForm.valid) {
      if (this.totalrunninghour != "") {
        if (this.imagePaths.correctivemaintenanceImagePath != "") {
          ...
          console.log(this.item_imageArr);
  ...
  addNewassignedtoRow() {
    ...
    const rowcontrol = this.newcorrectivemaintenanceForm.get("itemRows");
    if (rowcontrol.length > 0 || this.partsArr.length > 0) {
      /***********************************Staff Validation************************************/
      const rowcontrol =
  ...
  save(value) {
    ...
    var req = {
      ...
      leader_id: this.newcorrectivemaintenanceForm.value.select_leader,
