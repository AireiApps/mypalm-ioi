...
@Component({
  selector: "app-code-pressmachinemaintenancereport",
  templateUrl: "./code-pressmachinemaintenancereport.page.html",
  styleUrls: ["./code-pressmachinemaintenancereport.page.scss"],
})
export class CodePressmachinemaintenancereportPage implements OnInit {
  ...
  get assignedtoformArr() {
    return this.pressmachinemaintenancereportForm.get(
      "assignedtoRows"
    ) as FormArray;
  }
  ...
  addNewassignedtoRow() {
    ...
    if (this.pressmachinemaintenancereportForm.value.select_teamlead == "") {
      this.commonservice.presentToast("error", "Leader Selection is mandatory");
      return;
    }

    if (this.pressmachinemaintenancereportForm.value.select_staff == "") {
    ...
    /***********************************Staff Validation************************************/
    const rowcontrol =
      this.pressmachinemaintenancereportForm.get("assignedtoRows");
    for (let i = 0; i < rowcontrol.length; i++) {
      const controlsub = <FormGroup>(
        this.pressmachinemaintenancereportForm.get(["assignedtoRows", i])
      );
      ...
      const selectedstaff = JSON.parse(
        this.pressmachinemaintenancereportForm.value.select_staff
      ).userId;
    ...
    if (staff_validate) {
      this.commonservice.presentToast(
        "error",
        JSON.parse(this.pressmachinemaintenancereportForm.value.select_staff)
    ...
    this.assignedtoformArr.push(
      this.initassignedtoRows(this.pressmachinemaintenancereportForm.value)
    );
    this.pressmachinemaintenancereportForm.controls.select_staff.setValue("");
  }
  ...
  save() {
    ...
    if (this.pressmachinemaintenancereportForm.valid) {
      var req = {
        ...
        teamlead: this.pressmachinemaintenancereportForm.value.select_teamlead,
