...
@Component({
  selector: 'app-code-report-pressmachinevibrationcheck',
  templateUrl: './code-report-pressmachinevibrationcheck.page.html',
  styleUrls: ['./code-report-pressmachinevibrationcheck.page.scss'],
})
export class CodeReportPressmachinevibrationcheckPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/press_machine_vibration_check?user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
