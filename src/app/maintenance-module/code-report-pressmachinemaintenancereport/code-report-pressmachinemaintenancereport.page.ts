...
@Component({
  selector: 'app-code-report-pressmachinemaintenancereport',
  templateUrl: './code-report-pressmachinemaintenancereport.page.html',
  styleUrls: ['./code-report-pressmachinemaintenancereport.page.scss'],
})
export class CodeReportPressmachinemaintenancereportPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/Press_machine_maintenance_report?report_id=1&user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
