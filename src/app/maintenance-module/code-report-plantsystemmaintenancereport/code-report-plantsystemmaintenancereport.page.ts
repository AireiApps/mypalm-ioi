...
@Component({
  selector: 'app-code-report-plantsystemmaintenancereport',
  templateUrl: './code-report-plantsystemmaintenancereport.page.html',
  styleUrls: ['./code-report-plantsystemmaintenancereport.page.scss'],
})
export class CodeReportPlantsystemmaintenancereportPage implements OnInit {
  ...
  getUrl() {
    ...
    if(this.zoneid == "0" && this.stationid == "0" && this.machineryid == "0")
    {
      formatedurl =
      this.baseurl +
      "/index.php/Mobile/Press_machine_maintenance_report?report_id=2&user_id=" +
      this.userid +
      "&departmentid=" +
      this.departmentid +
      "&millcode=" +
